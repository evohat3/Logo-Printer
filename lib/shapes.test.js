  ...
  it('returns a square SVG string with the correct attributes', () => {
    ...
    answers = {
        ...
        textcolor: '#FFFFFF'
         ...
         expected = `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x="100" y="50" width="150" height="200" fill="${answers.shapecolor}"></rect><text x="175" y="150" font-size="60" text-anchor="middle" fill="${answers.textcolor}">${answers.text}</text></svg>`
      expect(generateShape(answers)).toEqual(expected)
  });
});
